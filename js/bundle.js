...
const LUMI = {
  ...
  journal: {
    ...
    items: [{
      ...
      deck: {
        zh: '基于近年法国、意大利属地拍摄的项目数据,分析高定影像制作中,临场应变与流程规范之间的实际冲突;并探讨 SPOC 与 Change Order 机制在跨境项目中的具体应用。',
      ...
      deck: {
        zh: '以 SHIATZY CHEN「舞玉」短片系列为案例,讨论中欧高端品牌在叙事结构、视觉密度与文化引用上的差异,并探究在跨文化语境中,品牌内核如何实现有效的跨语言转译。',
    ...
    sampleEssay: {
      body: {
        zh: ['王陈彩霞女士 1990 年在巴黎开设第一间工作室,是法国时尚协会当时唯一的大中华区品牌创办人。她生产的是中式服装,但用的是欧洲高定的工作方式。', '这个案例值得长期复盘。它表明:跨文化表达的成立,最终取决于工作方式的磨合,而非单纯的符号转用。', '过去二十年,中国高端品牌的国际化大多停在符号上。工作方法、决策习惯、对客户的态度——这些更底下的部分,几乎没有人系统地写过。'],
        en: ['Madame Wang Chen Tsai-Hsia opened her first Paris atelier in 1990, at the time the only founder from Greater China admitted to the Chambre Syndicale. She made Chinese clothing — using European haute couture working methods.', "This case is worth revisiting at length. What it shows: whether cross-cultural expression holds together depends ultimately on the negotiation of working methods, not the transfer of surface signs.", "Most premium-brand internationalisation from China over the past two decades has stayed at the level of surface signs. Working method, decision habits, posture toward clients — the deeper layers — almost no one has written about them systematically."]
      },
      pull: {
  ...
  vision: {
    ...
    body: {
      zh: ['过去十年,我在巴黎和上海之间走。我看到欧洲品牌进入中国时,把品牌叙事交给了不理解他们的代理商;也看到中国品牌走向欧洲时,被本地 PR 公司讲成了「另一个东方风情」。', '在中欧两边都有代表作的创作者,一直都不多。', '这件事一个人做不了。它需要摄影师、导演、美术、属地制片 —— 每个人长期在自己的文化里工作,彼此用同一套方法。', 'Lumicome 想做的就是这件事。', '我们以巴黎与上海为两端,把分散在全球的华人创作者组织起来。', '中欧高端品牌走向相互理解的这十年里,这样一个网络会被需要。'],
      en: ['Over the past decade I have been walking between Paris and Shanghai. I watched European brands hand their narrative over to Chinese agencies that did not understand them. I watched Chinese brands go to Paris and be reduced by local PR to "another oriental story."', 'Creators with signature work in both China and Europe — there have always been few.', 'This work cannot be done by one person. It takes photographers, directors, art directors, field producers — each working long-term in their own culture, all working under the same method.', 'That is what Lumicome is.', 'We hold Paris and Shanghai as our two ends, and gather scattered Chinese creators worldwide.', 'Over the next decade, as premium brands in China and Europe move toward each other, this kind of network will be needed.']
    },
    sign: {
    ...
    pillars: [{
      ...
      v: {
        zh: '中欧之间长期缺乏能够深度承接双重文化的创作者,品牌故事在跨国落地时,往往因语境错位而偏离初衷。',
        en: 'Between China and Europe, there has long been a shortage of creators able to carry both cultures with depth; brand stories tend to drift from their original intent as they cross borders, lost to context.'
      }
    }, {
      k: {
        zh: '机会',
      ...
      v: {
        zh: '过去十年,中欧高端品牌正在加速双向进入;与此同时,全球华人创作者群体也在同步成长。两股力量正交汇于此。',
        en: 'Over the past decade, premium brands in China and Europe have been accelerating their two-way entry; meanwhile, the worldwide community of Chinese creators has been growing in parallel. The two currents are converging.'
      }
    }, {
      k: {
        zh: '我们的位置',
  ...
  legal: {
    ...
    sections: [{
      ...
      body: {
        zh: '本站依据欧盟《通用数据保护条例》(GDPR · 2016/679)、法国《数据保护法》(loi Informatique et Libertés)与中国《个人信息保护法》(PIPL · 2021)处理访客的个人信息。',
...
function FooterBlock({
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Lumicome"), /*#__PURE__*/React.createElement("p", null, lang === 'zh' ? '中欧跨境创意事务所。' : 'A China–Europe cross-border creative atelier.'), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 8,
      color: 'var(--mute)'
    }
