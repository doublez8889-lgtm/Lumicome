  ...
  vision: {
    ...
    body: {
      zh: [
        ...
        '在中欧两边都有代表作的创作者,一直都不多。',
        '这件事一个人做不了。它需要摄影师、导演、美术、属地制片 —— 每个人长期在自己的文化里工作,彼此用同一套方法。',
        'Lumicome 想做的就是这件事。',
        '我们以巴黎与上海为两端,把分散在全球的华人创作者组织起来。',
      ...
      en: [
        ...
        'Creators with signature work in both China and Europe — there have always been few.',
        'This work cannot be done by one person. It takes photographers, directors, art directors, field producers — each working long-term in their own culture, all working under the same method.',
        'That is what Lumicome is.',
        'We hold Paris and Shanghai as our two ends, and gather scattered Chinese creators worldwide.',
