...
const LUMI = {
  ...
  team: {
    ...
    founder: {
      ...
      name:    'YF',
      based:   { zh: '常驻巴黎 · 上海两地',         en: 'Based in Paris & Shanghai' },
      langs:   { zh: '工作语言 · 中文 / 法语 / 英语', en: 'Working languages · Mandarin · French · English' },
      bio: {
        zh: [
          '十年来在巴黎与上海之间工作。前 Printemps 大中华区艺人事务统筹,Forbes Global Alliance 成员;在中欧高端品牌战略、影像创作、跨文化项目统筹上持续实践。',
          '主导的代表项目包括 SHIATZY CHEN「舞玉」品牌短片系列、Printemps 总部 Asian Marketing 委任的跨境项目协同等。研究方向覆盖跨境影像制作流程治理、属地法务合规、跨文化叙事美学。',
        ],
        en: [
          'A decade of work between Paris and Shanghai. Former Greater China Talent Affairs lead at Printemps under HQ Asian Marketing; member of the Forbes Global Alliance. Continuing practice in premium-brand strategy, visual production, and cross-cultural coordination between China and Europe.',
          'Lead on projects including the SHIATZY CHEN Dance of Jade film series and the cross-border production mandate from Printemps Asian Marketing HQ. Research interests cover cross-border production governance, jurisdictional compliance, and the aesthetics of cross-cultural narrative.',
        ],
      },
      links: [
        { label: 'LinkedIn',    href: 'https://www.linkedin.com/', note: { zh: '查询 / 索取',     en: 'On request' } },
        { label: 'Email',       href: 'mailto:hello@atelieryf.com', note: { zh: '直接来信',       en: 'Direct line' } },
      ],
      plate: { line1: 'FOUNDER · YF', line2: 'Paris × Shanghai', line3: 'MMXV — MMXXVI', tag: '01' },
    },
    members: [
      {
        role:  { zh: '战略与跨境项目',     en: 'Strategy & Cross-border Production' },
        name:  { zh: '招募中',               en: 'Open position' },
        based: { zh: '巴黎',                 en: 'Paris' },
        bio:   { zh: '主导项目治理 · SPOC · Change Order 流程在跨境环境下的落地。', en: 'Project governance · SPOC · Change Order in cross-border execution.' },
        plate: { line1: 'STRATEGY', line2: 'Cross-border', line3: 'Paris', tag: '02' },
      },
      {
        role:  { zh: '影像制作与导演协调',  en: 'Production & Director Coordination' },
        name:  { zh: '招募中',               en: 'Open position' },
        based: { zh: '上海',                 en: 'Shanghai' },
        bio:   { zh: '负责创作者匹配 · 现场制片协同 · 影像质量把控。', en: 'Creator matching · field production · visual quality control.' },
        plate: { line1: 'PRODUCTION', line2: 'Shanghai', line3: 'On-the-ground', tag: '03' },
      },
      {
        role:  { zh: '编辑与行业研究',       en: 'Editorial & Industry Research' },
        name:  { zh: '招募中',               en: 'Open position' },
        based: { zh: '巴黎 / 远程',          en: 'Paris / Remote' },
        bio:   { zh: '负责 Journal 栏目研究、属地法务合规、行业方法论沉淀。', en: 'Journal research, jurisdictional compliance, methodology archive.' },
        plate: { line1: 'EDITORIAL', line2: 'Research', line3: 'Paris', tag: '04' },
      },
    ],
    advisors: {
