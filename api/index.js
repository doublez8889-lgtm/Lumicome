...
var networkApplications = mysqlTable("network_applications", {
  id: int("id").autoincrement().primaryKey(),
...
var appRouter = router({
  ...
  network: router({
    ...
    uploadPortfolio: publicProcedure.input(
      z2.object({
    ...
    submitApplication: publicProcedure.input(
      z2.object({
        ...
        portfolioFileKey: z2.string().optional(),
        portfolioFileUrl: z2.string().optional(),
        portfolioFileName: z2.string().optional()
      })
    ).mutation(async ({ input }) => {
      const db = await getDb();
